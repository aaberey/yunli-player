...
var musicDir = './music/Bonda1'; // Substitua pelo caminho correto
var coverImage = './images/Bonda1.png'; // Imagem da capa
...
async function generateMusicList() {
  try {
    ...
    await fs.writeFile('Bonda1.json', JSON.stringify(musicList, null, 2));
