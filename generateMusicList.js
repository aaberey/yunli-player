...
var musicDir = './music/SEGURA'; // Substitua pelo caminho correto
var coverImage = './images/SEGURA.png'; // Imagem da capa
...
async function generateMusicList() {
  try {
    ...
    await fs.writeFile('SEGURA.json', JSON.stringify(musicList, null, 2));
