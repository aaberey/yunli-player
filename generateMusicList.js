...
var musicDir = './music/Validation'; // Substitua pelo caminho correto
var coverImage = './images/Validation.png'; // Imagem da capa
...
async function generateMusicList() {
  try {
    ...
    await fs.writeFile('Validation.json', JSON.stringify(musicList, null, 2));
